    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 main-content">
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h2 class="fw-bold text-dark m-0">Catégories de Réclamations</h2>
            </div>

            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card-custom h-100">
                        <h5 class="fw-bold mb-4">Ajouter une catégorie</h5>
                        <form method="POST">
                            <div class="mb-3">
                                <label class="form-label text-muted small text-uppercase fw-bold">Nom</label>
                                <input type="text" name="nom" class="form-control rounded-pill" placeholder="Ex: Plomberie..." required>
                            </div>
                            <button type="submit" name="add_cat" class="btn btn-add w-100 shadow-sm">Ajouter</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card-custom h-100">
                        <h5 class="fw-bold mb-4">Catégories existantes</h5>
                        <ul class="list-group">
                            <?php foreach ($categories as $cat): ?>
                            <li class="list-group-item">
                                <span class="fw-medium"><?php echo htmlspecialchars($cat['nom']); ?></span>
                                <a href="?delete=<?php echo $cat['id']; ?>" class="text-danger small" onclick="return confirm('Supprimer ?');"><i class="fas fa-trash"></i></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
