...
$sidebar_name = isset($user['nom']) ? $user['nom'] : ($_SESSION['user_nom'] ?? ($_SESSION['user_name'] ?? 'Alami Ahmed'));
...
function render_avatar($avatar, $name) {
    if (!empty($avatar)) {
        ...
        $vals = explode(' ', $name);
        $initials = strtoupper(substr($vals[0], 0, 1) . substr($vals[1] ?? '', 0, 1));
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar" style="background-color: var(--sidebar-bg); color: white;">
    ...
    <div class="offcanvas-body">
        <div class="user-profile-card d-flex align-items-center mb-4 p-3" style="background: rgba(255, 255, 255, 0.1); border-radius: 12px;">
            ...
            <div>
                ...
                <small class="text-white-50">Réclamant</small>
            </div>
        </div>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="my_reclamations.php" class="nav-link <?php echo ($current_page == 'my_reclamations.php') ? 'active' : ''; ?>">
                    <i class="fas fa-file-invoice"></i> Mes réclamations
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="faq.php" class="nav-link">
                    <i class="fas fa-question-circle"></i> Aide & FAQ
                </a>
            </li>
